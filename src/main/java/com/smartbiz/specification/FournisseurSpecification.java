...
public final class FournisseurSpecification {

    private FournisseurSpecification() {
    }

    public static Specification<Fournisseur> avecFiltres(String recherche, Boolean actif) {
